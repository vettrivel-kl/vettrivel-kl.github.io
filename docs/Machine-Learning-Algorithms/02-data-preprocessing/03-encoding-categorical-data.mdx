...
export const EncoderSandbox = () => {
  ...
  return (
    <div style={{ padding: '20px', border: '1px solid var(--ifm-color-emphasis-200)', borderRadius: '8px', backgroundColor: 'rgba(148, 163, 184, 0.05)', margin: '20px 0' }}>
      <h4 style={{ margin: '0 0 10px 0' }}>🎛️ Live Encoder Sandbox</h4>
...
*   **⚠️ Capacity solves ordering:** Unrestricted tree ensembles suffer zero penalty from false orderings because deep splits route around the integer mapping perfectly.

...
export const SplitLottery = () => {
  ...
  return (
    <div style={{ padding: '20px', border: '1px solid var(--ifm-color-emphasis-200)', borderRadius: '8px', backgroundColor: 'rgba(148, 163, 184, 0.05)', margin: '20px 0' }}>
      <h4 style={{ margin: '0 0 10px 0' }}>🎛️ Live Split Lottery Simulator</h4>
  ...
  return (
    <div style={{ padding: '20px', border: '1px solid var(--ifm-color-emphasis-200)', borderRadius: '8px', backgroundColor: 'rgba(148, 163, 184, 0.05)', margin: '20px 0' }}>
      ...
      <div style={{ fontSize: '12px', color: 'var(--ifm-color-emphasis-600)', fontStyle: 'italic' }}>
        {splitType === 'random' && "⚠️ Patient Leakage! Notice how Patient A has Scan A1 & A3 in Train, and Scan A2 in Test. The model will recognize Patient A's identity rather than learning general disease signatures, reporting an artificial 89% accuracy when true accuracy is only 47%!"}
...
**Next in this section:** [Simple Linear Regression](../03-linear-regression/01-simple-linear-regression.md)

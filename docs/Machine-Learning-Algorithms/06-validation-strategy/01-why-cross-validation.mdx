...
<Tabs>
  ...
  <TabItem value="twoway" label="⚠️ 2. Two-Way Split (Train / Test)">
    <br/>
...
*   **🛡️ The Sealed Vault:** The test partition is a sealed envelope opened exactly once. The moment it guides any modeling decision, it ceases to be an honest test set.
...
**Next Section:** [Cross-Validation Methods](./02-cross-validation-methods.md) - exploring Leave-One-Out (LOO), Leave-P-Out (LPO), and K-Fold architectures.

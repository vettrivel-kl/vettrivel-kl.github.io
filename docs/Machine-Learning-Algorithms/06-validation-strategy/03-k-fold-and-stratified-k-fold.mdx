...
*   **Stratification protects rare classes:** On imbalanced problems, unstratified splits can create unrepresentative or completely empty test folds.
...
**Next Section:** [Data Leakage and Best Practices](./04-data-leakage-and-best-practices.mdx) - preventing subtle pipeline leakage, feature-scaling contamination, and mastering Nested CV.

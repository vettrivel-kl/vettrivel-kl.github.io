    ...
    <div style={{ padding: '20px', border: '1px solid var(--ifm-color-emphasis-200)', borderRadius: '8px', backgroundColor: 'rgba(148, 163, 184, 0.05)', margin: '20px 0' }}>
      ...
      {mode === 'leaky' ? (
        ...
        <div style={{ padding: '16px', borderLeft: '4px solid #38a169', backgroundColor: 'rgba(56, 161, 105, 0.08)', borderRadius: '4px' }}>
          <strong style={{ color: '#38a169', fontSize: '16px' }}>🛡️ Protection: Atomic Pipeline Isolation</strong>
          <p style={{ margin: '8px 0', fontSize: '14px' }}>
...
<div className="row">
  ...
  <div className="col col--6">
    <div className="card" style={{ height: '100%', marginBottom: '15px' }}>
      <div className="card__header">
        <h3>🛠️ Specialized Partitioning</h3>
      </div>
      <div className="card__body">
        <ul>
...
*   **🛡️ Pipeline is mandatory:** Never apply manual transformations before splitting. Pipelines ensure mathematical isolation per fold.

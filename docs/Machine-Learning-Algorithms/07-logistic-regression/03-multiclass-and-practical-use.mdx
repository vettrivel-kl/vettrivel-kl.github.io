        ...
        <div style={{ padding: '14px', borderRadius: '6px', backgroundColor: 'var(--ifm-background-surface-color)', border: '1px solid var(--ifm-color-emphasis-300)' }}>
          ...
          <div style={{ marginTop: '10px', paddingTop: '8px', borderTop: '1px dashed var(--ifm-color-emphasis-300)', fontSize: '13px' }}>
            ...
            <div style={{ fontSize: '11px', color: 'var(--ifm-color-emphasis-600)', marginTop: '2px' }}>
              {Math.abs(ovrSum - 1.0) > 0.05 ? '⚠️ Violates probability axioms (Sum ≠ 100%)' : 'Coincidentally near 100%'}
            </div>
          </div>
        </div>
...
**Next Module:** [Classification Metrics](../08-classification-metrics/01-confusion-matrix-and-basic-metrics.md) - evaluating classifiers via confusion matrices, precision, recall, F1-scores, and ROC-AUC curves.

...
**Next in this section:** [Types of Learning](./03-types-of-learning.md) — the labels-or-not divide these techniques keep turning on · [Reinforcement Learning](./04-reinforcement-learning.md) · [The Toolkit and the Pipeline](./05-toolkit-and-pipeline.md)

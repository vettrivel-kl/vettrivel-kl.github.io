...
*   **Scalers are Estimators too:** A StandardScaler learns mean and deviation vectors on `.fit()`. Fitting it on testing partitions or prior to splitting constitutes structural **Data Leakage**.
